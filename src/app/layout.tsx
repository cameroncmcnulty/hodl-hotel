...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <link rel="preload" as="image" href="/art/landing-bg.jpg?v=4" media="(min-width: 768px)" />
        <link rel="preload" as="image" href="/art/landing-mobile.jpg?v=4" media="(max-width: 767px)" />
      </head>
