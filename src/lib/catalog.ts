...
export const CATALOG: FurnDef[] = [
  ...
  F({ id: "sofa_corner", name: "Teal Sofa", desc: "Two-seat lounge. Occupies two full tiles.", category: "seating", price: 160, w: 2, d: 1, h: 1.4, rarity: "uncommon", sittable: true, use: "sit", shape: "sofa", colors: { top: "#2ec4b6", left: "#1a8f86", right: "#f5e6cc" } }),
...
export const HOTEL_FURN: FurnDef[] = [
  ...
  H({ id: "hq_sofa", name: "Neon Banquette", desc: "Club two-seat. Occupies two full tiles.", category: "hotel", w: 2, d: 1, h: 1.2, sittable: true, use: "sit", shape: "sofa", colors: { top: "#6b21c4", left: "#ff4fd8", right: "#3b0764" } }),
